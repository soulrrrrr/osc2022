...
void memory_init() {
    ...
    reserve_memory(MEMORY_BASE+0x0, MEMORY_BASE+(ulong)base);
    reserve_memory(MEMORY_BASE+0x8000000, MEMORY_BASE+(0x8000000+CPIO_SIZE));
    reserve_memory(MEMORY_BASE+0x3c000000, MEMORY_BASE+0x40000000);
